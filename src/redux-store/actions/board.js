...
export const saveBoard = (board) => async (dispatch) => {
    ...
    const url = 'https://us-central1-vision-board-2.cloudfunctions.net/saveBoard';
...
export const deleteBoard = (board) => async (dispatch) => {
    ...
    const url = 'https://us-central1-vision-board-2.cloudfunctions.net/deleteUserBoard';
...
export const getUserBoards = () => async (dispatch) => {
    ...
    const url = 'https://us-central1-vision-board-2.cloudfunctions.net/getUserBoards';
    const currentUser = firebase.auth().currentUser;
